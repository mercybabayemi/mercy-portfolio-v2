...
export const PROJECTS = {
  ...
  grid: [
    ...
    },
    {
      badge: 'Full-Stack',
      title: 'Auction App',
      desc: 'Fullstack real-time auction platform for the Black Rising Community. Features user registration with JWT authentication, auction listing creation, and instant bid updates via Socket.IO. Redis handles sessions and caching, Cloudinary manages image uploads. Built with layered backend architecture (routers, services, repositories, models) and Docker containerization.',
      stack: ['Flask', 'Python', 'Socket.IO', 'MongoEngine', 'Redis', 'Cloudinary', 'Docker', 'JWT'],
      links: [
        { label: 'GitHub →', href: 'https://github.com/mercybabayemi/Auction-App' },
        { label: 'Live Demo →', href: 'https://auctionapp-rl4y.onrender.com' },
      ],
    },
    {
      badge: 'Content & Web',
      ...
      links: [
        ...
        { label: 'Live →', href: 'https://blackrisingcommunity.org' },
      ],
    },
    {
      badge: 'Capstone',
